...
CREATE INDEX `idx_event_attendees_alumni_id` ON `event_attendees` (`alumni_id`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "email", "password_hash", "full_name", "role", "created_at") SELECT "id", "email", "password_hash", "full_name", "role", "created_at" FROM `users`;--> statement-breakpoint
